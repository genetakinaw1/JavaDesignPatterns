...
import com.designpatterns.behavioral.MauntainBikeRange;
...
//observerExample2();
    ...
    private static void iteratorExample2(){
      ...
      MauntainBikeRange bikeRange = new MauntainBikeRange();
    ...
    private static void facadeExample(){
        ...
        facade.PrepareForSale(new DawnwHill(new WideWheel(24)));
    }
